...
enum tokentype	{tokidentifier, toknumber, toksymbol, tokeof, tokerror, tokword, tokop};

/* ISSUE: I don't know why this statement will cause error: clang: error: linker command failed with exit code 1 (use -v to see invocation) */
...
private:
    ...
    std::ifstream	infile;			// The source file
protected:
